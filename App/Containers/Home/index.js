...
function Home(props) {
  ...
  function getRandomUserData(pagination) {
    setLoading(true);
    const {RandomUserDataAction} = props;
          ...
          <View style={styles.card}>
            ...
            <View style={styles.innercard}>
              ...
              <View>
                ...
                <View style={styles.EmailView}>
                  ...
                  <Text style={styles.textname2}>{`${item.email}`}</Text>
                </View>
                <View style={styles.EmailView}>
            ...
            <View style={styles.StreetView}>
              ...
              <View>
                ...
                <Text style={styles.textname}>{`${
                  item.location.state.charAt(0).toUpperCase() +
                  item.location.state.slice(1)
                }`}</Text>
              </View>
              <View>
                <Text style={[styles.label]}>Country</Text>
                <Text style={styles.textname}>{`${
                  item.location.country.charAt(0).toUpperCase() +
                  item.location.country.slice(1)
                }`}</Text>
              </View>
            </View>
          </View>
